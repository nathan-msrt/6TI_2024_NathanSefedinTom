...
<div class="navBar li flex1 a">
    ...
    <a class="a"  href="OurProgram">ACCUEIL</a> <!-- changer les href des a-->
    <a class="a"  href="connexion">CREER PROGRAMME</a>
    <a class="a"  href="insciptionOrEditProfile">VOIR PROGRAMME</a>
</div>