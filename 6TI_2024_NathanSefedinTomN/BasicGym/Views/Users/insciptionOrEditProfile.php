        ...
        <form method="post" action="" class="formCreate">
                <fieldset class="fieldsetInscription legendInscription">
                    ...
                    <div>
                        ...
                        <input type="text" placeholder="Nom" class="form-control" id="Nom" name="Nom"  required value="<?php if(isset($_SESSION["utilisateur"])) : ?><?= $_SESSION["utilisateur"]->utilisateurNom ?><?php endif ?>"> 
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="password" placeholder="Mot de passe" class="form-control" id="Login" name="Login" value="<?php if(isset($_SESSION["utilisateur"])) : ?><?= $_SESSION["utilisateur"]->utilisateurMotDePasse ?><?php endif ?>">
                    </div>
                    <div>
